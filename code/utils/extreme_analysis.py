...
def open_all_parent_nl(path):
    ...
    return nl, nl_qu,extremes, tech_nl,country_nl,region_nl

def open_atm_vars(path,scenario):
    ...
    dss = xr.merge(dss)
    dss_mn = dss.groupby("time.dayofyear").mean(("time","member"))
    return dss,dss_mn
